...
### 3.1 **Jenis kejahatan paling dominan:**
Berdasarkan `value_counts()` pada `Primary Type`, kategori seperti THEFT, BATTERY, dan CRIMINAL DAMAGE mendominasi jumlah kejadian, sementara SEX OFFENSE menjadi kasus kejahatan terendah.
